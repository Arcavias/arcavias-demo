...
class Email_DeliveryTest extends MW_Unittest_Testcase
{
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Delivery_Default( self::$_context, $paths );
	...
	public function testSendProgress()
	{
		$this->_view->extOrderItem->setDeliveryStatus( MShop_Order_Item_Abstract::STAT_PROGRESS );
	...
	public function testSendDispatched()
	{
		$this->_view->extOrderItem->setDeliveryStatus( MShop_Order_Item_Abstract::STAT_DISPATCHED );
	...
	public function testSendRefused()
	{
		$this->_view->extOrderItem->setDeliveryStatus( MShop_Order_Item_Abstract::STAT_REFUSED );
	...
	public function testSendReturned()
	{
		$this->_view->extOrderItem->setDeliveryStatus( MShop_Order_Item_Abstract::STAT_RETURNED );
